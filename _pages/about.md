...
![Amsterdam, Netherlands](/assets/images/gauravjain-knbve9xxH4U-unsplash.jpg){: .rounded-10 }
_Amsterdam. Where I learned that correctness at scale is a systems problem, not a testing problem. Photo by [Gaurav Jain](https://unsplash.com/@gauravjain) on Unsplash._

A stint at King taught me what "high throughput" really means when millions of people are playing games simultaneously.

![Barcelona, Spain](/assets/images/logan-armstrong-aX5NLrKgRBc-unsplash.jpg){: .rounded-10 }
_Barcelona. Where "millions of concurrent users" stopped being an abstraction. Photo by [Logan Armstrong](https://unsplash.com/@loganarmstrong) on Unsplash._
